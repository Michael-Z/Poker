...
$CellContext`suitNoChoice]]}, {
      Hold[
       Text[
        Style[
        "Probability Distribution (by buckets) of Hand Ranks", 11, Bold]]], 
      Manipulate`Dump`ThisIsNotAControl}, {{
...
- By Hand Type", Larger, Bold]], "\n", 
            $CellContext`tableTypeHand[$CellContext`handRankBin$], "\n", "\n", 
            Text[
             Style[
             "Probability Distribution of Hand Ranks for a given PreFlop Hand \
- By Hand Rank Bucket", Larger, Bold]], 
            $CellContext`rectChartPreFlopHand[$CellContext`handRankPoint$, \
$CellContext`nbHandRankBucket$$]}, Center]]], "Specifications" :> {
        Text[
         Style[
...
$CellContext`suitNoChoice]], ControlType -> SetterBar}, Delimiter, 
        Text[
         ...
         "Probability Distribution (by buckets) of Hand Ranks", 11, 
          Bold]], {{$CellContext`nbHandRankBucket$$, 20, 
